...
from .loss import DualSelfTeachingLoss, DualSelfTeachingMultiPositiveLoss
...
class DualSelfTeachingDenseModel(DenseModel):
    def __init__(
        ...
        effective_loss = DualSelfTeachingMultiPositiveLoss if train_args.multi_positive else DualSelfTeachingLoss
        self.dst_loss = effective_loss(
